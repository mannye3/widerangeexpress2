      ...
      <div class="container">
        <div class="row">              
            <div class="col-lg-7 ml-lg-auto pos-rel col-md-12">               
              ...
              <form action="<?php echo URLROOT; ?>users/login" method="post" id="contactoption" novalidate="novalidate" class="rounded-field">
					...
					<div class="form-row mb-8">
                      ...
                      <br>
                          ...
                          <button name="contactoption" id="contactoption" type="submit" class="form-btn mx-auto btn-theme bg-orange">Login <i class="icofont-rounded-right"></i></button>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo URLROOT; ?>users/register">  Don't have account? Register</a>
