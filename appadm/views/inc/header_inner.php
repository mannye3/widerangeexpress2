...
<head>
        <meta charset="utf-8" />
        <title>OwnerDirect Admin Portal</title>
  ...
  <!--venobox lightbox-->
        <link rel="stylesheet" href="<?php echo URLROOT; ?>public/adm/plugins/magnific-popup/css/magnific-popup.css"/>
        ...
        <script src="<?php echo URLROOT; ?>public/adm/assets/js/modernizr.min.js"></script>
